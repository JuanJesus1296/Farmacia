...
function sumatorias(){
  $(document).ready(function(){
    ...
    $('#tabla_ventas_credito > tbody > tr').each(function(){
         ...
         $("#total_credito").html("");
         $("#total_credito").html("<span class='label label-success'>Total: S/. "+total_credito.toFixed(2)+"</span> | <span class='label label-success'>Cancelaciones: S/. "+detalle_cancelado.toFixed(2)+"</span> | <span class='label label-danger'>Venta Neta: S/. "+detalle.toFixed(2)+"</span>");
        });
       /*tabla de contado*/
        ...
        $('#tabla_ventas_contado > tbody > tr').each(function(){
         ...
         $("#total_contado").html("");
         $("#total_contado").html("<span class='label label-success'>Total: S/. "+total_contado.toFixed(2)+"</span> | <span class='label label-success'>Cancelaciones: S/. "+detalle_cancelado_contado.toFixed(2)+"</span> | <span class='label label-danger'>Venta Neta: S/. "+detalle_contado.toFixed(2)+"</span>");
        });
        ...
        /*tabla de gastos*/
         ...
         $("#total_de_los_gastos").html("<span class='label label-success'>Total: S/. "+total_gastos.toFixed(2)+"</span>");
        });
        ...
        /*tabla de abonos*/
         ...
         $("#total_de_los_abonos").html("<span class='label label-success'>Total: S/. "+total_abonos.toFixed(2)+"</span>");
        });
        var venta_neta=detalle_contado+detalle;

       $("#global").html("<div class='callout callout-success'><h3>Venta: S/."+venta_neta.toFixed(2)+"<br>"+
       "Cancelaciones: S/."+(detalle_cancelado_contado+detalle_cancelado)+"<br>"+
       "Abonos de Clientes: S/."+total_abonos+"<br>"+
       "Gastos: S/."+total_gastos+"<br>"+
       "Total en Caja: S/."+((total_contado+total_abonos-total_gastos).toFixed(2))+"<h3></div>");
     })
}
/*********************************************************************************************/
function print1(){
...
function sumatorias_general(){
  $(document).ready(function(){
    ...
    $('#tabla_inventarios > tbody > tr').each(function(){
                ...
                total_ar+=ar;
         $(".aqui").html("");
         $(".aqui").html("<h4>Existencias a la Fecha: "+$("#fecha").val()+" | "+leyenda+" | <span class='label label-primary'>Total de articulos: "+total_ar.toFixed(2)+"</span> | <span class='label label-primary'>Costo Total: S/. "+total_monto.toFixed(2)+"</label></h4><button type='button' class='btn btn-warning btn-xs pull-right no-print' onclick='print_existe_todo();'><i class='fa fa-print'></i> Imprimir</button>");
        });
     })
}
/**************************************************************************************/
